...
selected_wall = [[0, 0], [1, 1], [2, 2], [4, 11]]  # wall coordinates

for i in range(len(selected_wall)):  # drawing the walls based on the wall coordinates
    grid[selected_wall[i - 1][0]][selected_wall[i - 1][1]] = inf
    draw_square(selected_wall[i - 1][0], selected_wall[i - 1][1], WALL)
